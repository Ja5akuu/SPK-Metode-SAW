					...
					<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-uppercase"><?php echo  $data->level ;?></td>
								<td>														 
									<a href="<?php echo base_url().'user/edit/'.$data->id_user.'';?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Edit</a>&nbsp;
									<a href="<?php echo base_url().'user/delete/'.$data->id_user.'';?>" class="btn btn-danger btn-sm"  onClick="return confirmDialog()"><i class="fa fa-pencil"></i> Delete</a>
								</td>
								</tr>
								<?php endforeach ?>
							</tbody>
